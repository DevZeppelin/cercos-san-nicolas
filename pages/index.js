            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-12 px-12 md:px-32 pb-16 ">
              <Fade bottom>
                <div className="space-y-8 pb-6">
                  <BsFillPersonCheckFill className="text-4xl text-dgreen mx-auto" />
              ...
              <Fade bottom>
              <div className="space-y-8 pb-6">
                <FaRecycle className="text-4xl text-dgreen mx-auto" />
              ...
              <Fade bottom>
              <div className="space-y-8 pb-6">
                <AiOutlineStar className="text-4xl text-dgreen mx-auto" />
              ...
              <Fade bottom>
              <div className="space-y-8 pb-6">
                <FaUserCog className="text-4xl text-dgreen mx-auto" />
